...
public class StudentInformatieTest {
	...
	private static final String url = "http://localhost:8080/Labo_3_Opdracht_2_war_exploded/";
	private WebDriver driver;
	
	@Before
	public void setUp () {
		 System.setProperty("webdriver.chrome.driver", "C:\\Users\\jonas\\OneDrive - UC Leuven-Limburg\\2020-2021\\Semester 2\\Webontwikkeling 2\\Server\\ChromeDriver\\chromedriver.exe");
		driver = new ChromeDriver();
	}

	@Test
	public void test_StudentInfo_Steegmans_Elke_geeft_resultaat () {
		driver.get(url+"Servlet?achternaamField=Steegmans&voornaamField=Elke");
	...
	private void fillOutForm(String naam, String voornaam) {
		...
		driver.findElement(By.id("achternaam")).sendKeys(naam);
	...
	public void test_StudentInfo_Kemme_Mieke_geeft_geen_resultaat () {
		driver.get(url+"Servlet?naam=Kemme&voornaam=Mieke");
		String resultaat = driver.findElement(By.tagName("p")).getText();
